...
trait Mapper[E, I] { this: JdbcTransaction =>
  ...
  val pk: Option[PrimaryKeyColumnDefinition[E,I]] = None
  ...
  def generatedPrimaryKey[E,I](n: String, st: SqlType[I], g: E => I, s: (E,I)=>E) = {
    new PrimaryKeyColumnDefinition[E,I] with AutoGeneratedColumn[E,I]{
  ...
  lazy val updateSqlString = {
    "update "+tableName+" set "+updatable.map(_.name+"=?").mkString(",")+" where "+pk.get.name+"=?"
  }
